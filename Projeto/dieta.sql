...
INSERT INTO `Dieta`.`tb_objective` (`idt_objective`, `nme_objective`) VALUES (3, 'Redução alimentar');
...
INSERT INTO `Dieta`.`tb_food` (`idt_food`, `nme_food`, `val_calories`, `val_weight`) VALUES (3, 'Pão Integral', 100, 200);
