...
CREATE TABLE IF NOT EXISTS `Dieta`.`diet` (
  ...
  CONSTRAINT `fk_Dieta_Objetivo1`
    ...
    REFERENCES `Dieta`.`objective` (`idt_objective`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Dieta`.`user_diet` (
  ...
  CONSTRAINT `fk_Usuario_has_Dieta1_Usuario1`
    ...
    REFERENCES `Dieta`.`user` (`idt_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Usuario_has_Dieta1_Dieta1`
    FOREIGN KEY (`cod_diet`)
    REFERENCES `Dieta`.`diet` (`idt_diet`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Dieta`.`diet_food` (
  ...
  CONSTRAINT `fk_tb_dieta_has_tb_alimento_tb_alimento1`
    ...
    REFERENCES `Dieta`.`food` (`idt_food`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Dieta`.`food_location` (
  ...
  CONSTRAINT `fk_tb_alimento_has_tb_localizacao_tb_localizacao1`
    ...
    REFERENCES `Dieta`.`location` (`idt_location`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`user` (`idt_user`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (1, 'Higo Soares', 'higo', '020202020', 'higo@gmail.com', '33434332', 55, 1.69, 20, true);
INSERT INTO `Dieta`.`user` (`idt_user`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (2, 'Gustavo Oliveira', 'gustavo', '123456789', 'gustavo@gmail.com', '22222222', 70.2, 1.55, 25, false);
INSERT INTO `Dieta`.`user` (`idt_user`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (3, 'Amado Batista', 'amado', '987654321', 'amado@gmail.com', '33333333', 91.6, 1.80, 30, false);
INSERT INTO `Dieta`.`user` (`idt_user`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (4, 'Bruno Lima', 'bruno', '616283818', 'bruno@gmail.com', '44444444', 67, 1.70, 35, false);
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`objective` (`idt_objective`, `nme_objective`) VALUES (1, 'Hipertrofia');
INSERT INTO `Dieta`.`objective` (`idt_objective`, `nme_objective`) VALUES (2, 'Perda de peso');
INSERT INTO `Dieta`.`objective` (`idt_objective`, `nme_objective`) VALUES (3, 'Reducao alimentar');
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`diet` (`idt_diet`, `dat_init`, `dat_final`, `val_ideal_weight`, `cod_objective`) VALUES (1, '2016-09-17', '2016-09-17', 66, 1);
INSERT INTO `Dieta`.`diet` (`idt_diet`, `dat_init`, `dat_final`, `val_ideal_weight`, `cod_objective`) VALUES (2, '2016-01-20', '2016-07-20', 68.5, 2);
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`food` (`idt_food`, `nme_food`, `val_calories`, `val_weight`) VALUES (1, 'Abacaxi', 200, 200);
INSERT INTO `Dieta`.`food` (`idt_food`, `nme_food`, `val_calories`, `val_weight`) VALUES (2, 'Banana', 300, 100);
INSERT INTO `Dieta`.`food` (`idt_food`, `nme_food`, `val_calories`, `val_weight`) VALUES (3, 'Pao Integral', 100, 200);
INSERT INTO `Dieta`.`food` (`idt_food`, `nme_food`, `val_calories`, `val_weight`) VALUES (4, 'Peito de Frango', 200, 100);
INSERT INTO `Dieta`.`food` (`idt_food`, `nme_food`, `val_calories`, `val_weight`) VALUES (5, 'Batata Doce', 150, 100);
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`location` (`idt_location`, `cord_longitude`, `cord_latitude`) VALUES (1, -2.323123, -0.28282);
INSERT INTO `Dieta`.`location` (`idt_location`, `cord_longitude`, `cord_latitude`) VALUES (2, -9.282872, -0.22222);
INSERT INTO `Dieta`.`location` (`idt_location`, `cord_longitude`, `cord_latitude`) VALUES (3, -8.231231, -0.23333);
INSERT INTO `Dieta`.`location` (`idt_location`, `cord_longitude`, `cord_latitude`) VALUES (4, -9.272722, 9.222222);
INSERT INTO `Dieta`.`location` (`idt_location`, `cord_longitude`, `cord_latitude`) VALUES (5, -1.123123, -0.72727);
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`diet_food` (`cod_diet`, `cod_food`) VALUES (1, 1);
INSERT INTO `Dieta`.`diet_food` (`cod_diet`, `cod_food`) VALUES (1, 2);
INSERT INTO `Dieta`.`diet_food` (`cod_diet`, `cod_food`) VALUES (2, 3);
INSERT INTO `Dieta`.`diet_food` (`cod_diet`, `cod_food`) VALUES (2, 4);
INSERT INTO `Dieta`.`diet_food` (`cod_diet`, `cod_food`) VALUES (2, 5);
