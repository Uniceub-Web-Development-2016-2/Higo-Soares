...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`user` (`id`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (1, 'Higo Soares', 'higo', '020202020', 'higo@gmail.com', '33434332', 55, 1.69, 20, true);
INSERT INTO `Dieta`.`user` (`id`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (2, 'Gustavo Oliveira', 'gustavo', '123456789', 'gustavo@gmail.com', '22222222', 70.2, 1.55, 25, false);
INSERT INTO `Dieta`.`user` (`id`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (3, 'Amado Batista', 'amado', '987654321', 'amado@gmail.com', '33333333', 91.6, 1.80, 30, false);
INSERT INTO `Dieta`.`user` (`id`, `nme_user`, `num_password`, `val_cpf`, `nme_email`, `num_phone`, `val_weight`, `val_height`, `val_age`, `admin`) VALUES (4, 'Bruno Lima', 'bruno', '616283818', 'bruno@gmail.com', '44444444', 67, 1.70, 35, false);
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`objective` (`id`, `nme_objective`) VALUES (1, 'Hipertrofia');
INSERT INTO `Dieta`.`objective` (`id`, `nme_objective`) VALUES (2, 'Perda de peso');
INSERT INTO `Dieta`.`objective` (`id`, `nme_objective`) VALUES (3, 'Reducao alimentar');
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`diet` (`id`, `dat_init`, `dat_final`, `val_ideal_weight`, `cod_objective`) VALUES (1, '2016-09-17', '2016-09-17', 66, 1);
INSERT INTO `Dieta`.`diet` (`id`, `dat_init`, `dat_final`, `val_ideal_weight`, `cod_objective`) VALUES (2, '2016-01-20', '2016-07-20', 68.5, 2);
...
START TRANSACTION;
USE `Dieta`;
INSERT INTO `Dieta`.`food` (`id`, `nme_food`, `val_calories`, `val_weight`) VALUES (1, 'Abacaxi', 200, 200);
INSERT INTO `Dieta`.`food` (`id`, `nme_food`, `val_calories`, `val_weight`) VALUES (2, 'Banana', 300, 100);
INSERT INTO `Dieta`.`food` (`id`, `nme_food`, `val_calories`, `val_weight`) VALUES (3, 'Pao Integral', 100, 200);
INSERT INTO `Dieta`.`food` (`id`, `nme_food`, `val_calories`, `val_weight`) VALUES (4, 'Peito de Frango', 200, 100);
INSERT INTO `Dieta`.`food` (`id`, `nme_food`, `val_calories`, `val_weight`) VALUES (5, 'Batata Doce', 150, 100);
